    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-base-200"> {/* Added a light bg for contrast */}
      <div className="card w-96 bg-base-100 shadow-xl">
        <div className="card-body">
          <h2 className="card-title justify-center text-3xl mb-6">CodeApex</h2> {/* Added mb-6 for spacing */}
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-control">
              ...
              <input
                type="text"
                placeholder="John"
                //after submitting the form validation check and if there is a error ,error will set and re-rendering occur
